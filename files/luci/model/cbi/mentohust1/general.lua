...
m = Map("mentohust1", translate("MentoHUST"), translate("Configure MentoHUST 802.11x."))

s = m:section(TypedSection, "mentohust1", translate("Status"))
s.anonymous = true
status = s:option(DummyValue,"_mentohust1_status", "MentoHUST")
status.value = "<span id=\"_mentohust1_status\">%s</span>" %{is_running("mentohust1")}
status.rawhtml = true
t = io.popen('uci get mentohust1.@mentohust1[0].pinghost')
...
o = m:section(TypedSection, "mentohust1", translate("Settings"))
o.addremove = false
o.anonymous = true
...
datafile.default = "/etc/mentohust1/"
...
if apply then
    io.popen("/etc/init.d/mentohust1 restart")
end
